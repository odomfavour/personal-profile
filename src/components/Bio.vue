                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <ul>
                                            <li>
                                                <label>Phone: </label>
                                                <span>(+234) 806 6748 8682</span>
                                            </li>
                                            <li>
                                                <label>Email: </label>
                                                <span>ogochukwuodom@gmail.com</span>
                                            </li>
                                            <li>
                                                <label>Twitter: </label>
                                                <span>ogochukwuodom</span>
                                            </li>
                                            <li>
...
<style scoped>
    ...
    .about-me .social-icons a:hover i {
        color: #0b0b13;
        transform: scale(1.4);
    }
